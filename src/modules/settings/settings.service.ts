...
export const SETTING_DEFAULTS = {
  ...
  freeze_min_days: 3,
  /**
   * Давхарласан урамшууллын нийт хөнгөлөлтийн ДЭЭД хязгаар (%).
   *
   * ⚠ Олон урамшуулал зэрэг явах боломжтой болсноос хойш энэ нь цорын
   * ганц хамгаалалт: «20% + 30% + 40%» санамсаргүй давхцвал багц бараг
   * үнэгүй зарагдана. Хязгаар нь нийт хөнгөлөлтийг тасална — аль
   * урамшуулал бүтнээрээ орохыг `sort_order` шийднэ.
   */
  promo_max_discount_pct: 60,
  /**
  ...
  /**
   * Бэлгийн картын Loopy программ — гишүүнчлэлийнхээс ТУСДАА.
   *
   * Гишүүнчлэлийн карт нь эрхийн огноо, төлөв, гишүүний дугаартай.
   * Бэлгийн карт нь бэлэглэсэн хүн, хүлээн авагч, дүн, ашигласан эсэх —
   * тэс өөр талбарууд. Нэг программд багтаах гэвэл хоёулаа эвгүй.
   */
  loopy_gift_program_id: null as string | null,
  /**
