...
export class Member {
  ...
  /**
   * Энэ терминалын хүн нь ҮНЭНДЭЭ АЖИЛТАН.
   *
   * Терминал дээр ажилтан, дасгалжуулагч нар царайгаа бүртгүүлсэн
   * байдаг бөгөөд төхөөрөмж тэднийг гишүүдээс ялгадаггүй. Энэ
   * холбоос байвал тайлангийн ирцийн тооцооллоос ХАСНА
   * (migration 1788160000000). Үйлдлийн эрхээрээ өөрчлөгдөхгүй —
   * энэ нь зөвхөн ТАЙЛАНГИЙН тэмдэг.
   */
