  ...
  async receive(
    ...
    for (const e of events) {
      ...
      if (m.employeeNo === null) {
         ...
         *
         * `granted` (75/104/8): хүн ТАНИГДСАН мөртлөө дугаар нь огт
         * ирээгүй (хоосон) эсвэл 32 тэмдэгтээс урт. Текст дугаар
         * өөрөө одоо ХЭВИЙН (`member_no` текст болсон,
         * 1788150000000) тул энэ салаа нь зөвхөн жинхэнээс хоосон
         * тохиолдолд л ажиллана — тэгэхээр ирц үнэхээр алдагдаж байна.
         */
        if (cls.kind === 'denied') {
        ...
        skipped.push(
          `${code} ⚠ ТАНИГДСАН ч дугааргүй (employeeNo=${got})${who} — ирц алдагдаж байна`,
        );
        continue;
      }
