...
export class TaskService {
   ...
   *
   * ★ ӨНӨӨДРИЙНХИЙГ ГҮЙЦЭТГЭСЭН Ч БУЦААНА
   *
   * Урьд нь зөвхөн гүйцэтгээгүйг өгдөг байв — тэгэхээр сая
   * тэмдэглэсэн ажил жагсаалтаас АЛГА болж, буруу дарсан бол
   * буцаах замгүй болдог байсан. Мөн бүгд хийгдсэн үед
   * хуудас бүхэлдээ хоосорч «юу хийсэн бэ» гэдгийг харах аргагүй.
   *
   * Хоцорсон нь харин зөвхөн гүйцэтгээгүй: өнгөрсөн өдрийн
   * хийгдсэн ажил нь үүргээ дууссан — нүүрэн дээр зай эзлэхгүй.
   */
  async todo(staffId: string): Promise<{
    ...
    return {
      today,
      items: all.filter((o) => o.on === today),
      overdue: all.filter((o) => o.on < today && !o.done),
    };
  }
