...
async function bootstrap() {
  ...
  /*
   * Facebook Messenger-ийн түлхэлт — бас ТҮҮХИЙГЭЭР.
   *
   * ⚠ `X-Hub-Signature-256` нь БИЕИЙН ТҮҮХИЙ БАЙТ дээр тооцогдоно.
   *   JSON задлагч ажилласан бол дахин цуглуулсан текст нь эх
   *   хувилбартай таарахгүй (зай, escape, талбарын дараалал) тул
   *   гарын үсэг ҮРГЭЛЖ буруу гарна. Глобал угтвараас ӨМНӨ бүртгэнэ.
   */
